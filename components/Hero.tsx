      ...
      <div className="h-full items-start heroS justify-center flex flex-col w-full">
        ...
        <div className="mx-[10vw] h-auto">
          <h1
            ...
            className={`${CaladeaF} text-black capitalize text-3xl max-w-[800px] md:text-[4vw]`}
          >
            Handles incoming & outgoing customer interactions other.
          </h1>
          <p className={`${CaladeaF} text-md text-black md:text-2xl mt-4 max-w-[900px]`}>
          ...
          <div className="mt-6">
            <Link
              className={`${CaladeaF} flex items-center gap-2 font-extrabold px-4 md:px-8 py-3 max-w-fit text-black bg-white rounded-md text-lg md:text-xl`}
              href="#contact"
            >
